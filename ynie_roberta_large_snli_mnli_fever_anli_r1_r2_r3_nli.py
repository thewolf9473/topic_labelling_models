# -*- coding: utf-8 -*-
"""ynie/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli.ipynb
...
classifier = pipeline("zero-shot-classification", model="ynie/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli")
